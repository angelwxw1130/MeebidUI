...
<script>
  ...
  export default {
    name: 'meebid-number-input',

    componentName: 'meebidNumberInput',
    ...
    watch: {
      ...
      /**'value'(val, oldValue) {
        if (meebidUtils.isNumber(parseFloat(val))) {
          this.setCurrentValue(meebidUtils.formatMoney("", parseFloat(val), true));
        } else {
          this.setCurrentValue("0.00");
        }
      }*/
    },
    ...
    methods: {
      ...
      /**handleInput(event) {
        ...
        if (isNaN(parseFloat(value))) {
          ...
          value = meebidUtils.formatMoney("", parseFloat(value), true);
        }
      ...
      handleChange(event) {
        ...
        if (isNaN(parseFloat(value))) {
          ...
          value = meebidUtils.formatMoneyForNumberField("", parseFloat(value), true, 2);
        }
        event.target.value = value;
        this.$emit('input', value);
        this.setCurrentValue(value);
